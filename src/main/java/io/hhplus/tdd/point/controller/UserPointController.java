...
public class UserPointController {
    ...
    public ResponseEntity<UserPointResponseDto> charge(@PathVariable(name ="id") Long id
                          , @RequestBody UserPointRequestDto userPointRequestDto) {
       return ResponseEntity.ok(userPointService.chargeUserPoint(id, userPointRequestDto.getAmount()));
    }
    ...
    public ResponseEntity<UserPointResponseDto> use(@PathVariable(name ="id") Long id
        ...
        return ResponseEntity.ok(userPointService.useUserPoint(id, userPointRequestDto.getAmount()));
    }
}
